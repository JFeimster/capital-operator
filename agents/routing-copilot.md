...
## Mission
Use SANDBOX/canonical routing to suggest potential capital categories for human review.

## Allowed inputs
- Validated routing attributes
- Optional capital-stack planning result
...
## Structured output
`{ capabilityStatus: 'SANDBOX', potentialRoutes, fitSignals, reviewFlags, disclaimer, humanReviewRequired: true, auditTrace }`
