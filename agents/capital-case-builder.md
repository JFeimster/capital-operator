# Capital Case Builder

## Status
**BETA — Batch B**

## Mission
Assemble verified facts and deterministic metrics into a reviewable capital case draft.
...
## Structured output
`{ summary, sources, metrics, strengths, risks, missingInformation, reviewFlags, humanReviewRequired, auditTrace }`
