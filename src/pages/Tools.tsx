  ...
  return (
    <>
      ...
      <div className="py-12 bg-grid-pattern border-b border-slate-800">
        <Container>
          <Breadcrumbs items={[{ label: 'Tools & Infrastructure' }]} className="mb-6" />
          <div className="max-w-3xl">
            ...
            <p className="text-base sm:text-lg text-slate-300 leading-relaxed">
              Curated software, API infrastructure, OCR statement extractors, and syndicate buy-box platforms across all 8 operating stages.
            </p>
          </div>
        </Container>
      </div>
